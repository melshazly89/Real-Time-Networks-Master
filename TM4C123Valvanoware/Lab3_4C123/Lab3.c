...
//  //TExaS_Init(LOGICANALYZER, 6831); // initialize the Lab 3 grader
//  TExaS_Init(GRADESTEP2, 6831);    // initialize the Lab 3 grader
...
//  TExaS_Init(LOGICANALYZER, 6831); // initialize the Lab 3 grader
//  //TExaS_Init(GRADESTEP3, 6831);    // initialize the Lab 3 grader
//  OS_Launch(BSP_Clock_GetFreq()/1000);
//  return 0;             // this never executes
//}
/* ****************************************** */
...
//  //TExaS_Init(LOGICANALYZER, 6831); // initialize the Lab 3 grader
//  TExaS_Init(GRADESTEP4, 6831);    // initialize the Lab 3 grader
//  OS_Launch(BSP_Clock_GetFreq()/1000);
//  return 0;             // this never executes
//}
/* ****************************************** */
...
//  //TExaS_Init(LOGICANALYZER, 6831); // initialize the Lab 3 grader
//  TExaS_Init(GRADESTEP5, 6831);    // initialize the Lab 3 grader
//  OS_Launch(BSP_Clock_GetFreq()/1000);
//  return 0;             // this never executes
//}
/* ****************************************** */
...
//  }
 ...
 //TExaS_Init(GRADER, 6831 );          // initialize the Lab 3 grader
 TExaS_Init(LOGICANALYZER, 6831); // initialize the Lab 3 logic analyzer
