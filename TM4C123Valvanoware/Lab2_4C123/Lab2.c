...
int main(void){
  ...
  //TExaS_Init(GRADER, 3282);          // initialize the Lab 2 grader
TExaS_Init(LOGICANALYZER, 3282); // initialize the Lab 2 logic analyzer
...
//  // when grading change 1000 to 4-digit number from edX
//  TExaS_Init(GRADER, 4653);          // initialize the Lab 2 grader
////TExaS_Init(LOGICANALYZER, 4653); // initialize the Lab 2 logic analyzer
//  OS_Launch(BSP_Clock_GetFreq()/THREADFREQ); // doesn't return, interrupts enabled in here
//  return 0;             // this never executes
//}
////***************Step 4*************************
