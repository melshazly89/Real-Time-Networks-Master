...
int main(void){
  ...
  OS_AddThreads(&Task0,0, &Task1,1, &Task6,3,&Task2,2, &Task3,3, 
	              &Task4,3, &Task5,3,  &Task7,4);
...
//TExaS_Init(GRADER, 7157  );          // initialize the Lab 4 grader
TExaS_Init(LOGICANALYZER, 7157); // initialize the Lab 4 logic analyzer
...
//   TExaS_Init(LOGICANALYZER, 7157); // initialize the Lab 4 grader
//   //TExaS_Init(GRADESTEP1, 7157);    // initialize the Lab 4 grader
...
//  //TExaS_Init(LOGICANALYZER, 7157); // initialize the Lab 4 grader
//  TExaS_Init(GRADESTEP2, 7157);    // initialize the Lab 4 grader
//  OS_Launch(BSP_Clock_GetFreq()/1000);
//  return 0;             // this never executes
//}
/* ****************************************** */
...
//  TExaS_Init(LOGICANALYZER, 7157); // initialize the Lab 4 grader
//  //TExaS_Init(GRADESTEP3, 7157);    // initialize the Lab 4 grader
//  OS_Launch(BSP_Clock_GetFreq()/1000);
//  return 0;             // this never executes
//}
/* ****************************************** */
